...
export default function Footer() {
  return(
    <footer role="contentinfo" className={styles.footer}>
      ...
      <p className={styles.copy}><a href="https://nubank.com.br/pagar/4tc3b/4e5TDadPmY" target="_blank" rel="noopener noreferrer"><small><Icon icon="eva:heart-fill" /> Buy me a coffee</small></a></p>
    </footer>
  )
}
